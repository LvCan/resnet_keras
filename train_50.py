...
from resnet_model import resnet_50
import matplotlib.pyplot as plt
import time
def train(retrain=False,size=64,eps=10):
    if retrain:
        model=keras.models.load_model('model/train_model_50.h5')
        ...
        model.save('model/train_model_50.h5')
    else:
        model=resnet_50()
...
if __name__=='__main__':
    ...
    train(retrain=True,size=32,eps=3)
